...
function create_account() {
    ...
    # Build the container.
    docker build \
        -t "eu.gcr.io/k8s-workshop-2/console:${name}" \
    ...
    docker push "eu.gcr.io/k8s-workshop-2/console:${name}"
...
function create_resource_quotas() {
    local name
    name=$1
    kubectl apply \
            -f ./namespace-resource-limit.yml \
            -f ./namespace-resource-quota.yml \
            --namespace="$name"
}
